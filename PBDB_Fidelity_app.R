...
# Record start time
print(paste("Search sentences for non-candidate formation macrostrat names", Sys.time()))
...
# Record end time
print(paste("Finish search for sentences with non-candidate formation macrostrat names.",Sys.time()))
